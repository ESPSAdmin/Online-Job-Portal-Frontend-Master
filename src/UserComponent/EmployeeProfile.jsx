...
const EmployeeProfile = () => {
  ...
  return (
    <div className="container-fluid">
      <div className="container-sm px-3 my-4 py-4 bg-profile overflow-hidden rounded-card">
        <div className="row ps-3 align-items-center justify-content-center">
          ...
          <div className="col-lg">
            <h2 className="display-3 m-0 p-0 fw-bold text-light">
              {employee.firstName} {employee.lastName}
            </h2>
            <span className="text-light fw-bold">
              {employee.userProfile.bio}
            </span>
            <p className="d-flex pt-3 align-items-center gap-1 text-light">
              <FaLocationDot />
              <span className="h6 m-0 text-capitalize">
                {employee.address.city}
              </span>
            </p>
            <p className="d-flex align-items-center gap-1 text-light">
              <MdEmail />
              {employee.emailId}
            </p>
          </div>
